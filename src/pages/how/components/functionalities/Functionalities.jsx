...
export default function Functionalities() {
  return (
    <div className="functionalities-container">
      <div className="functionalities-container__section">
        <div className="functionalities-container__section__functionality1">
          <div className="functionalities-container__section__functionality1__image">
            <img src={functionality} alt="Laptop" />
          </div>
          <div className="functionalities-container__section__functionality1__text">
            <h1>Our Featured Functionalities</h1>
            <p>Here’re some of the features Flex has to offer.</p>
            <div className="functionalities-container__section__functionality1__text__feature">
        ...
        <div className="functionalities-container__section__functionality2">
          <div className="functionalities-container__section__functionality1__image">
            <img src={functionality} alt="Laptop" />
          </div>
          <div className="functionalities-container__section__functionality1__text">
